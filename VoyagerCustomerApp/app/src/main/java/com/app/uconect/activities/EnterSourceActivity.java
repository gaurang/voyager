...
import com.app.uconect.destination.DestinationPlaces;
import com.app.uconect.destination.EnterDestinationAutocompleteAdapter;
...
/**
 * Created by atul on 24/4/16.
 */
public class EnterSourceActivity extends ParentActivity implements GoogleApiClient.OnConnectionFailedListener,View.OnClickListener,AdapterView.OnItemClickListener{
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    public void BindView(View view, Bundle savedInstanceState) {
        ...
        destination=getIntent().getStringExtra("SOURCE");
        ...
        headername.setText("Enter Source");
        preferenceHelper=new PreferenceHelper(this);
        progressdialog = new ProgressDialogView(EnterSourceActivity.this, "Please wait..");
        ...
        mAutocompleteView.setHint("Enter your Source");
        ...
        mAdapter = new EnterDestinationAutocompleteAdapter(this, mGoogleApiClient,
                null);
