 ...
 */
public class WorkPlacesActivity extends ParentActivity implements GoogleApiClient.OnConnectionFailedListener,View.OnClickListener{
    ...
    public void BindView(View view, Bundle savedInstanceState) {
        ...
        headername.setText("Add Office");
        remove=(Button) findViewById(R.id.removeHome);
        preferenceHelper=new PreferenceHelper(this);
        progressdialog = new ProgressDialogView(WorkPlacesActivity.this, "Please wait..");
        ...
        if(workAddress.toString().length()!= 0){
            home1.setVisibility(View.VISIBLE);
            home1.setText(""+workAddress);
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            try {
                work=places.get(0).getName().toString()+","+places.get(0).getAddress().toString();
                ...
                jsonObject.put(Constants.FAVLABLE, "Work");
                jsonObject.put(Constants.FAVNAME, formatPlaceDetails(getResources(), places.get(0).getName(),
                        "", places.get(0).getAddress(), "",null));
                jsonObject.put(Constants.CUSTOMER_ID, Session.getUserID(WorkPlacesActivity.this));
    ...
    public void CallADDPLACESAPI(JSONObject params) {
        if (Util.isNetworkConnected(WorkPlacesActivity.this)) {
            try {
                if (progressdialog.isShowing())
                    progressdialog.dismiss();
                progressdialog.show();
                new CallAPI(ADDFAVOURITEPLACES, "ADDFAVOURITEPLACES", params, WorkPlacesActivity.this, GetResend_Handler, true);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        } else {
            progressdialog.dismissanimation(ProgressDialogView.ERROR);
            Util.ShowToast(WorkPlacesActivity.this, getString(R.string.nointernetmessage));
        }
    }
                ...
                if (msg.getData().getInt("code") == SUCCESS) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (jsonObject.getString("favLabel").equals("Work")) {
                                Methods.toastShort("Added to office successfully", WorkPlacesActivity.this);
                                jsonObject.put(Constants.ADDRESS, work);
                                preferenceHelper.addString("Work", "" + jsonObject.toString());
...
//                                textView1_office.setText(jsonObject.getString("favName"));
                    ...
                    progressdialog.dismissanimation(ProgressDialogView.ERROR);
                    Util.ShowToast(WorkPlacesActivity.this, msg.getData().getString("msg"));
                }
            } else {
                progressdialog.dismissanimation(ProgressDialogView.ERROR);
                Util.ShowToast(WorkPlacesActivity.this, msg.getData().getString("msg"));
...
//                home=places.get(0).getName().toString()+""+places.get(0).getAddress().toString()+"";
            ...
            jsonObject = new JSONObject();
            jsonObject_main = getCommontHeaderParams();
            jsonObject.put("customerId", Session.getUserID(WorkPlacesActivity.this));
            jsonObject.put(Constants.FAVLABLE, "Office");
        ...
        if (Util.isNetworkConnected(WorkPlacesActivity.this)) {
            try {
                if (progressdialog.isShowing())
                    progressdialog.dismiss();
                progressdialog.show();
                new CallAPI(DELFAVOURITEPLACES, "DELFAVOURITEPLACES", params, WorkPlacesActivity.this, GetDel_Handler, true);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        } else {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (jsonObject.getString("favLabel").equals("Home")) {
                                Methods.toastShort("Added to home successfully", WorkPlacesActivity.this);
                                jsonObject.put(Constants.ADDRESS, work);
