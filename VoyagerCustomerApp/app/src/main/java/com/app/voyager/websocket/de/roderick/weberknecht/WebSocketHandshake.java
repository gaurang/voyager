...
package com.app.voyager.websocket.de.roderick.weberknecht;

import com.app.voyager.websocket.net.iharder.Base64;
...
public class WebSocketHandshake {
    ...
    public void verifyServerHandshakeHeaders(HashMap<String, String> headers)
            throws WebSocketException {
        if (!headers.get("Upgrade").toLowerCase().equalsIgnoreCase("websocket")) {
