...
public class trackride extends ParentActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == cancelride) {
            ...
            Intent startActivity = new Intent(com.osi.voyagerdriver.trackride.this,HelpActivity.class);
            startActivity(startActivity);
        } else if (v == confirm) {
           ...
           getRideStart();
//            Intent startActivity = new Intent(com.osi.voyagerdriver.trackride.this,trackride1.class);
//            startActivity(startActivity);
        }else if(v == ic_back){
            finish();
        }else if(v == navigate){
