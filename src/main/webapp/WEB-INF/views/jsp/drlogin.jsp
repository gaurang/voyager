	...
	<h3><?=$error?></h3>
           ...
           <c:if test="${param.error != null}">
			...
			<div class="form">
				...
				<input type="text" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';"  name="email" value="Email" />
			</div><!-- Login User Name -->
			...
			<a class="btns  red  sml-btn" id="submit"  href="https://serviciosweb.pro-mujer.org:8443/" style="margin-right: 20px;">Forgot Password ?</a>
...
<spring:url value="/${pageContext.request.contextPath}/resources/core/css/hello.js" var="coreJs" />
<spring:url value="/${pageContext.request.contextPath}/resources/core/css/bootstrap.min.js" var="bootstrapJs" />
