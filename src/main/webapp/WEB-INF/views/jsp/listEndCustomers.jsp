										...
										<div class="table-responsive">
											...
											<table class="table table-striped">
												<tr>
                 								...
                 								<c:if test="${fn:length(listEndCustomers)> 0}">
							                    	<c:forEach items="${listEndCustomers}" var="l" varStatus="index">
														<tr>
															<td><a href="#">${l.customerId}</a></td>
															<td><div id="sparkline-1">${l.fname} ${l.lname}</div></td>
