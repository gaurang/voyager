                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3>
                                        $ ${ridesDashboard['rideTotalAmt']==null?0:ridesDashboard['rideTotalAmt']} 
                                    </h3>
                                    <p>
                                ...
                                <a href="listHistory" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3>
                                        ${custCount}<sup style="font-size: 20px"></sup>
                                    </h3>
                                    <p>
                                        Customers
                                    </p>
                                ...
                                <a href="listEndCustomers" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="listDrivers" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box box-danger" id="loading-example">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Active CSE</h3>
                                </div><!-- /.box-header -->
                                        ...
                                        <div class="col-sm-5">
                                            <div class="pad">
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <small class="pull-right">${activeCse[0]}/${activeCse[2]}</small>
                                                </div>
                                                <div class="progress xs">
                                                    <div class="progress-bar progress-bar-green" style="width: ${activeCse[0]/activeCse[2] *100}%;"></div>
                                                </div>

                                                <div class="clearfix">
                                                    <span class="pull-left">Private Vehicle</span>
                                                    <small class="pull-right">${activeCse[1]}/${activeCse[3]}</small>
                                                </div>
                                                <div class="progress xs">
                                                    <div class="progress-bar progress-bar-red" style="width: ${activeCse[1]/activeCse[3] * 100}%;"></div>
                                                </div>
